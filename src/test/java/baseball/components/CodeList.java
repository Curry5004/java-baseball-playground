...
public class CodeList {
    ...
    public static final String RESULT_STRIKE = "01";
    public static final String RESULT_BALL = "02";
    public static final String RESULT_NOTING = "03";
    public static final int SCORE_LENGTH = 3;
